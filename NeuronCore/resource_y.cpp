...
#define yyval	res_yyval
#define yypvt	res_yypvt
#define yyerrflag	res_yyerrflag
#define yynerrs	res_yynerrs
...
yyTypedRules yyRules[] = {
  {"&00: %01 &00", 0}, {"%01: %02", 0}, {"%01: %01 %02", 0}, {"%02: %03", 0}, {"%02: %04", 0}, {"%03: &04 &03", 0}, {"%04: &05 &02 &03", 0},
  {"$accept", 0}, {"error", 0}
};yyNamedType yyTokenTypes[] = {
  {"$end", 0, 0}, {"error", 256, 0}, {"TEXT", 257, 1}, {"QTEXT", 258, 1}, {"DIRECTORY", 259, 0}, {"FILETOKEN", 260, 0}
};
#endif
static short yydef[] = {-1};
static short yyex[] = {0, 0, 65535, 1};
static short yyact[] = {65533, 65532, 260, 259, 65534, 257, 65529, 258, 65530, 258, -1};
static short yypact[] = {2, 9, 7, 5, 2};
static short yygo[] = {65535, 65527, 65528, 0, 65526, 65525, -1};
static short yypgo[] = {0, 0, 0, 5, 4, 0, 0, 2, 2, 0};
static short yyrlen[] = {0, 0, 0, 3, 2, 1, 2, 1, 1, 2};
#define YYS0	4
#define YYDELTA	2
#define YYNPACT	5
#define YYNDEF	1
...
#define YYrLR2	YYr9
#if YYDEBUG
char* yysvar[] = {"$accept", "res_file", "res_line", "dir_line", "file_line", 0};short yyrmap[] = {7, 8, 9, 6, 5, 1, 2, 3, 4, 0};short
yysmap[] = {6, 7, 2, 1, 0, 10, 8, 5, 9, 4, 3};int yyntoken = 6;int yynvar = 5;int yynstate = 11;int yynrule = 10;
#endif
...

{
  ...
  if (yys == (short*)0 || yyv == (YYSTYPE*)0
    ...
    res_error(m_textmsg(4967, "Not enough space for parser stacks", "E"));
    return 1;
  } save_yylval = res_lval; save_yyval = yyval; save_yypvt = yypvt; save_yychar = res_char; save_yyerrflag = yyerrflag; save_yynerrs =
    yynerrs;
#endif
...
yyStack: yyassert((unsigned)yystate < yynstate, m_textmsg(587, "state %d\n", ""), yystate);
  ...
  *++yytp = yyruletype; /* ... and type */
  ...
  if (res_debug) YY_TRACE(yyShowState)
#endif
...
yyEncore:
  ...
  else
  {
    ...
    if ((yyi = yydef[yystate]) < 0)
    {
      ...
      YYREAD;
#endif
      while ((yyi = *yyp) >= 0 && yyi != res_char) { yyp += 2; }
      yyi = yyp[1];
  ...
  yyj = yyrlen[yyi];
#if YYDEBUG
  if (res_debug) YY_TRACE(yyShowReduce) yytp -= yyj;
#endif
  yyps -= yyj; /* pop stacks */
  yypvt = yypv; /* save top */
  yypv -= yyj;
  ...
  case YYr5:
    {
      ...
      else
      {
        ...
        strcpy(aCurrResDir + strlen(aResDir), yypvt[0].sval);
      }
...
#if YYDEBUG
  if (res_debug) YY_TRACE(yyShowGoto)
#endif
  goto yyStack;
...
yyError:
  ...
  case 3:
    ...
    if (res_char == 0) /* but not EOF */
      break;
#if YYDEBUG
    if (res_debug) YY_TRACE(yyShowErrDiscard)
#endif
    yyclearin;
...
#ifdef YYALLOC
yyReturn:
  res_lval = save_yylval; yyval = save_yyval; yypvt = save_yypvt; res_char = save_yychar; yyerrflag = save_yyerrflag; yynerrs =
