...
#define yyval	strres_yyval
#define yypvt	strres_yypvt
#define yyerrflag	strres_yyerrflag
#define yynerrs	strres_yynerrs
...
#endif
#if YYDEBUG
yyTypedRules yyRules[] = {{"&00: %01 &00", 0}, {"%01: %02", 0}, {"%01: %01 %02", 0}, {"%02: &02 &03", 0}, {"$accept", 0}, {"error", 0}};
yyNamedType yyTokenTypes[] = {{"$end", 0, 0}, {"error", 256, 0}, {"TEXT", 257, 1}, {"QTEXT", 258, 1}};
#endif
static short yydef[] = {-1};
static short yyex[] = {0, 0, 65535, 1};
static short yyact[] = {65534, 257, 65532, 258, -1};
static short yypact[] = {1, 3, 1};
static short yygo[] = {65535, 65530, 65531, 0, -1};
static short yypgo[] = {0, 0, 0, 2, 0, 0, 0};
static short yyrlen[] = {0, 0, 0, 2, 1, 2, 2};
#define YYS0	2
#define YYDELTA	0
#define YYNPACT	3
#define YYNDEF	1
...
#define YYrLR2	YYr6
#if YYDEBUG
char* yysvar[] = {"$accept", "file", "line", 0};short yyrmap[] = {4, 5, 6, 3, 1, 2, 0};short yysmap[] = {3, 1, 0, 4, 2, 5};int yyntoken = 4;
int yynvar = 3;int yynstate = 6;int yynrule = 7;
#endif
...

{
  ...
  if (yys == (short*)0 || yyv == (YYSTYPE*)0
    ...
    strres_error(m_textmsg(4967, "Not enough space for parser stacks", "E"));
    return 1;
  } save_yylval = strres_lval; save_yyval = yyval; save_yypvt = yypvt; save_yychar = strres_char; save_yyerrflag = yyerrflag; save_yynerrs =
    yynerrs;
#endif
...
yyStack: yyassert((unsigned)yystate < yynstate, m_textmsg(587, "state %d\n", ""), yystate);
  ...
  *++yytp = yyruletype; /* ... and type */
  ...
  if (strres_debug) YY_TRACE(yyShowState)
#endif
...
yyEncore:
  ...
  else
  {
    ...
    if ((yyi = yydef[yystate]) < 0)
    {
      ...
      YYREAD;
#endif
      while ((yyi = *yyp) >= 0 && yyi != strres_char) { yyp += 2; }
      yyi = yyp[1];
  ...
  yyj = yyrlen[yyi];
#if YYDEBUG
  if (strres_debug) YY_TRACE(yyShowReduce) yytp -= yyj;
#endif
  yyps -= yyj; /* pop stacks */
  yypvt = yypv; /* save top */
  yypv -= yyj;
  ...
  case YYr3:
    {
      ...
      if (!strresStoreString(psCurrRes, yypvt[-1].sval, yypvt[0].sval)) { YYABORT; }
    }
    break;
...
#if YYDEBUG
  if (strres_debug) YY_TRACE(yyShowGoto)
#endif
  goto yyStack;
...
yyError:
  ...
  case 3:
    ...
    if (strres_char == 0) /* but not EOF */
      break;
#if YYDEBUG
    if (strres_debug) YY_TRACE(yyShowErrDiscard)
#endif
    yyclearin;
...
#ifdef YYALLOC
yyReturn:
  strres_lval = save_yylval; yyval = save_yyval; yypvt = save_yypvt; strres_char = save_yychar; yyerrflag = save_yyerrflag; yynerrs =
