...
extern BOOL surfLoadFrom8Bit(LPDIRECTDRAWSURFACE4 psSurf, // The surface to load to
 ...
 */
extern BOOL surfLoadFromSurface(LPDIRECTDRAWSURFACE4 psDest, // The surface to load to
