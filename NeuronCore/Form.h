...
using W_MINORTAB = struct _w_minortab
{
...
using W_MAJORTAB = struct _w_majortab
{
  /* Graphics data for the tab will go here */
...
using W_TABFORM = struct _w_tabform
{
  /* The common form data */
  FORM_BASE;
...
using W_CLICKFORM = struct _w_clickform
{
  /* The common form data */
  FORM_BASE;
...
using W_FORMGETALL = struct _w_formgetall
{
  WIDGET* psGAWList;
  W_TABFORM* psGAWForm;
