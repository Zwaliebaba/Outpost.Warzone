...
BOOL gameStatStart(void)
{
  ...
  */
  ...
  for (inc = 0; inc < MAX_PLAYERS; inc++)
  {
    for (comp = 0; comp < numStructureStats; comp++) { apStructTypeLists[inc][comp] = UNAVAILABLE; }
  }
  ...
  for (comp = 0; comp < numStructureStats; comp++)
  {
    ...
    {
      for (inc = 0; inc < MAX_PLAYERS; inc++) { apStructTypeLists[inc][comp] = AVAILABLE; }
    }
  ...
  for (comp = 0; comp < numWeaponStats; comp++)
  {
    ...
    {
      for (inc = 0; inc < MAX_PLAYERS; inc++) { apCompLists[inc][COMP_WEAPON][comp] = AVAILABLE; }
      break;
    }
  } for (comp = 0; comp < numSensorStats; comp++)
  {
    ...
    {
      for (inc = 0; inc < MAX_PLAYERS; inc++) { apCompLists[inc][COMP_SENSOR][comp] = AVAILABLE; }
      break;
    }
  } for (comp = 0; comp < numRepairStats; comp++)
  {
    ...
    {
      for (inc = 0; inc < MAX_PLAYERS; inc++) { apCompLists[inc][COMP_REPAIRUNIT][comp] = AVAILABLE; }
      break;
    }
  } for (comp = 0; comp < numPropulsionStats; comp++)
  {
    ...
    {
      for (inc = 0; inc < MAX_PLAYERS; inc++) { apCompLists[inc][COMP_PROPULSION][comp] = AVAILABLE; }
      break;
    }
  }
  /*for (comp=0; comp < numProgramStats; comp++)
  ...
  for (comp = 0; comp < numConstructStats; comp++)
  {
    ...
    {
      for (inc = 0; inc < MAX_PLAYERS; inc++) { apCompLists[inc][COMP_CONSTRUCT][comp] = AVAILABLE; }
      break;
    }
  } for (comp = 0; comp < numBrainStats; comp++)
  {
    ...
    {
      for (inc = 0; inc < MAX_PLAYERS; inc++) { apCompLists[inc][COMP_BRAIN][comp] = AVAILABLE; }
      break;
    }
  } for (comp = 0; comp < numBodyStats; comp++)
  {
    ...
    {
      for (inc = 0; inc < MAX_PLAYERS; inc++) { apCompLists[inc][COMP_BODY][comp] = AVAILABLE; }
      break;
    }
  }
  ...
  for (comp = 0; comp < numSensorStats; comp++)
  {
    if (!strcmp(asSensorStats[comp].pName, "Default Sensor"))
    {
      for (inc = 0; inc < MAX_PLAYERS; inc++) { aDefaultSensor[inc] = comp; }
      break;
    }
  } for (comp = 0; comp < numECMStats; comp++)
  {
    ...
    {
      for (inc = 0; inc < MAX_PLAYERS; inc++) { aDefaultECM[inc] = comp; }
      break;
    }
  }
#endif
