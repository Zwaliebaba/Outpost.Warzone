...
using SELECTION_CLASS = enum _selection_class
{
  DS_ALL_UNITS,
  DS_BY_TYPE
};

using SELECTIONTYPE = enum _selectiontype
{
  DST_UNUSED,
  DST_VTOL,
  DST_HOVER,
...
extern UDWORD selDroidSelection(UDWORD player, SELECTION_CLASS droidClass, SELECTIONTYPE droidType, BOOL bOnScreen);
