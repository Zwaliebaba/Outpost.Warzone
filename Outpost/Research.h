...
extern BOOL loadResearchArtefacts(SBYTE* pArteData, UDWORD bufferSize, UDWORD listNumber);
//Load the pre-requisites for a research list
extern BOOL loadResearchFunctions(SBYTE* pFunctionData, UDWORD bufferSize);
//Load the Structures for a research list
extern BOOL loadResearchStructures(SBYTE* pStructData, UDWORD bufferSize, UDWORD listNumber);
...
extern UWORD fillResearchList(UWORD* plist, UDWORD playerID, UWORD topic, UWORD limit);
