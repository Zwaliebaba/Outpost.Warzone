...
void pwrcSetPlayerCryptPower(UDWORD player, UDWORD power)
{
  ...
  ASSERT((player < MAX_PLAYERS, "pwrcSetPlayerCryptPower: invalid player number"));
...
{
  ASSERT((player < MAX_PLAYERS, "pwrcGetPlayerCryptPower: invalid player number"));
...
BOOL pwrcCheckPlayerCryptPower(UDWORD player, UDWORD power)
{
  ...
  ASSERT((player < MAX_PLAYERS, "pwrcCheckPlayerCryptPower: invalid player number"));
