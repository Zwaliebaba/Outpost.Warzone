...
using BASE_STATS = struct _base_stats
{
  STATS_BASE;
};
...
*/
using COMPONENT_TYPE = enum _component_type
{
  COMP_UNKNOWN,
  //COMP_ARMOUR,
  COMP_BODY,
...
using TECH_LEVEL = enum _tech_level
{
  TECH_LEVEL_ONE,
  TECH_LEVEL_TWO,
  TECH_LEVEL_THREE,
...
using COMP_BASE_STATS = struct _comp_base_stats
{
  COMPONENT_STATS;
};
...
using WEAPON_CLASS = enum _weapon_class
{
  WC_KINETIC,
  //bullets etc
...
using WEAPON_SUBCLASS = enum _weapon_subclass
{
  WSC_MGUN,
  WSC_CANNON,
  //WSC_ARTILLARY,
...
using MOVEMENT_MODEL = enum _movement_model
{
  MM_DIRECT,
  MM_INDIRECT,
  MM_HOMINGDIRECT,
...
using WEAPON_EFFECT = enum _weapon_effect
{
  WE_ANTI_PERSONNEL,
  WE_ANTI_TANK,
  WE_BUNKER_BUSTER,
...
using BODY_STATS = struct _body_stats
{
...
using BRAIN_STATS = struct _brain_stats
{
  /* Common stats */
  COMPONENT_STATS;
...
using PROP_SIDE = enum _prop_side
{
  LEFT_PROP,
  RIGHT_PROP,
  NUM_PROP_SIDES
...
using PROPULSION_TYPE = enum _propulsion_type
{
  WHEELED,
  TRACKED,
  LEGGED,
...
using PROPULSION_STATS = struct _propulsion_stats
{
  /* Common stats */
  COMPONENT_STATS;
...
using SENSOR_TYPE = enum _sensor_type
{
  STANDARD_SENSOR,
  INDIRECT_CB_SENSOR,
  VTOL_CB_SENSOR,
...
using SENSOR_STATS = struct _sensor_stats
{
  /* Common stats */
  COMPONENT_STATS;
...
using ECM_STATS = struct _ecm_stats
{
  /* Common stats */
  COMPONENT_STATS;
...
using REPAIR_STATS = struct _repair_stats
{
  /* Common stats */
  COMPONENT_STATS;
...
using FIREONMOVE = enum _fireonmove
{
  FOM_NO,
...
using WEAPON_STATS = struct _weapon_stats
{
  /* Common stats */
  COMPONENT_STATS;
...
using CONSTRUCT_STATS = struct _construct_stats
{
  /* Common stats */
  COMPONENT_STATS;
...
using TRAVEL_MEDIUM = enum _travel_medium
{
  GROUND,
  AIR
};

using PROPULSION_TYPES = struct _propulsion_types
{
...
using TERRAIN_TABLE = struct _terrain_table
{
...
using SPECIAL_ABILITY = struct _special_ability
{
  STRING* pName; // Text name of the component
};

using WEAPON_MODIFIER = UWORD;

/* weapon stats which can be upgraded by research*/
using WEAPON_UPGRADE = struct _weapon_upgrade
{
  UBYTE firePause;
  UWORD shortHit;
  UWORD longHit;
...
using SENSOR_UPGRADE = struct _sensor_upgrade
{
  UWORD power;
  UWORD range;
};
...
using ECM_UPGRADE = struct _ecm_upgrade
{
  UWORD power;
};

/*repair stats which can be upgraded by research*/
using REPAIR_UPGRADE = struct _repair_upgrade
{
  UWORD repairPoints;
};

/*constructor stats which can be upgraded by research*/
using CONSTRUCTOR_UPGRADE = struct _constructor_upgrade
{
  UWORD constructPoints;
};

/*body stats which can be upgraded by research*/
using BODY_UPGRADE = struct _body_upgrade
{
  UWORD powerOutput;
  UWORD body;
