...
extern float adjustDirection(float _present, float _difference);
extern float calcDirection(UDWORD x0, UDWORD y0, UDWORD x1, UDWORD y1);
 ...
 * result is 180 .. -180
 */
extern float directionDiff(float _a, float _b);
