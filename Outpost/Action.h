...
using DROID_ACTION = enum _droid_action
{
  DACTION_NONE,
  // not doing anything
...
extern BOOL actionTargetTurret(BASE_OBJECT* psAttacker, BASE_OBJECT* psTarget, float* pRotation, float* pPitch, WEAPON_STATS* psWeapStats,
                               BOOL bInvert);
