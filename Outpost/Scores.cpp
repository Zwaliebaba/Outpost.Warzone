...
/* Bar colours are packed A8R8G8B8 - the values of the palette entries the
 * table used to index */
STAT_BAR infoBars[] = {
  {LC_X, 100,STAT_BAR_WIDTH, 16, 10, STR_MR_UNITS_LOST, 0,FALSE,TRUE, 0, 0xffff2300}, // left column		STAT_UNIT_LOST       
  {LC_X, 120,STAT_BAR_WIDTH, 16, 20, STR_MR_UNITS_KILLED, 0,FALSE,TRUE, 0, 0xff37ef6f}, //	STAT_UNIT_KILLED         
  {LC_X, 160,STAT_BAR_WIDTH, 16, 30, STR_MR_STR_LOST, 0,FALSE,TRUE, 0, 0xffff2300}, //	STAT_STR_LOST            
  {LC_X, 180,STAT_BAR_WIDTH, 16, 40, STR_MR_STR_BLOWN_UP, 0,FALSE,TRUE, 0, 0xff37ef6f}, //	STAT_STR_BLOWN_UP        
  {LC_X, 220,STAT_BAR_WIDTH, 16, 50, STR_MR_UNITS_BUILT, 0,FALSE,TRUE, 0, 0xff2731b9}, //	STAT_UNITS_BUILT         
  {LC_X, 240,STAT_BAR_WIDTH, 16, 60, STR_MR_UNITS_NOW, 0,FALSE,TRUE, 0, 0xff2731b9}, //	STAT_UNITS_NOW           
  {LC_X, 260,STAT_BAR_WIDTH, 16, 70, STR_MR_STR_BUILT, 0,FALSE,TRUE, 0, 0xff2731b9}, //	STAT_STR_BUILT           
  {LC_X, 280,STAT_BAR_WIDTH, 16, 80, STR_MR_STR_NOW, 0,FALSE,FALSE, 0, 0xff2731b9}, //	STAT_STR_NOW             

  {RC_X, 100,RANK_BAR_WIDTH, 16, 10, STR_MR_LEVEL_ROOKIE, 0,FALSE,TRUE, 0, 0xffffeb13}, // right column	//	STAT_ROOKIE      
  {RC_X, 120,RANK_BAR_WIDTH, 16, 20, STR_MR_LEVEL_GREEN, 0,FALSE,TRUE, 0, 0xffffeb13}, //	STAT_GREEN       
  {RC_X, 140,RANK_BAR_WIDTH, 16, 30, STR_MR_LEVEL_TRAINED, 0,FALSE,TRUE, 0, 0xffffeb13}, //	STAT_TRAINED 
  {RC_X, 160,RANK_BAR_WIDTH, 16, 40, STR_MR_LEVEL_REGULAR, 0,FALSE,TRUE, 0, 0xffffeb13}, //	STAT_REGULAR 
  {RC_X, 180,RANK_BAR_WIDTH, 16, 50, STR_MR_LEVEL_VETERAN, 0,FALSE,TRUE, 0, 0xffffeb13}, //	STAT_VETERAN 
  {RC_X, 200,RANK_BAR_WIDTH, 16, 60, STR_MR_LEVEL_CRACK, 0,FALSE,TRUE, 0, 0xffffeb13}, //	STAT_CRACK       
  {RC_X, 220,RANK_BAR_WIDTH, 16, 70, STR_MR_LEVEL_ELITE, 0,FALSE,TRUE, 0, 0xffffeb13}, //	STAT_ELITE       
  {RC_X, 240,RANK_BAR_WIDTH, 16, 80, STR_MR_LEVEL_SPECIAL, 0,FALSE,TRUE, 0, 0xffffeb13}, //	STAT_SPECIAL 
  {RC_X, 260,RANK_BAR_WIDTH, 16, 90, STR_MR_LEVEL_ACE, 0,FALSE,TRUE, 0, 0xffffeb13}, //	STAT_ACE     
    ...
    if (infoBars[index].bActive)
    {
      ...
      if (((gameTime2 - dispST) > infoBars[index].queTime))
      {
        ...
        if (std::lrintf(length) > 4)
        {
          ...
          /* Solid coloured bit */
          pie_BoxFillIndex(x + 1, y + 2, x + std::lrintf(length) - 4, y + height - 4, infoBars[index].colour);
        }
      }
