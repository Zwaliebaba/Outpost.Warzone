...
IMAGEFRAME FrameNormal = {
  0, 0, 0, 0, IMAGE_FRAME_C0, IMAGE_FRAME_C1, IMAGE_FRAME_C3, IMAGE_FRAME_C2, IMAGE_FRAME_HT, FR_SOLID, IMAGE_FRAME_VR, FR_SOLID,
  IMAGE_FRAME_HB, FR_SOLID, IMAGE_FRAME_VL, FR_SOLID,
  {
    {FR_FRAME, 0, 1, 0, -1, 190}, {FR_IGNORE, 0, 0, 0, 0, 0}, {FR_IGNORE, 0, 0, 0, 0, 0}, {FR_IGNORE, 0, 0, 0, 0, 0},
    {FR_IGNORE, 0, 0, 0, 0, 0}
  },
};
...
IMAGEFRAME FrameRadar = {
  ...
  IMAGE_FRAME_HB, FR_SOLID, IMAGE_FRAME_VL, FR_SOLID,
  {
    {FR_IGNORE, 0, 0, 0, 0, 0}, {FR_IGNORE, 0, 0, 0, 0, 0}, {FR_IGNORE, 0, 0, 0, 0, 0}, {FR_IGNORE, 0, 0, 0, 0, 0},
    {FR_IGNORE, 0, 0, 0, 0, 0}
  },
};
...
TABDEF SystemTab = {
  IMAGE_DES_WEAPONS, IMAGE_DES_WEAPONSDOWN, IMAGE_DES_EXTRAHI, IMAGE_DES_WEAPONSDOWN,

  /*IMAGE_TAB1,
  IMAGE_TAB1DOWN,
  IMAGE_TABHILIGHT,
  IMAGE_TABSELECTED,*/
  IMAGE_SIDETAB, IMAGE_SIDETABDOWN, IMAGE_SIDETABHI, IMAGE_SIDETABSEL,
};
...
{
  IntImages = static_cast<IMAGEFILE*>(resGetData("IMG", "intfac.img"));
...
void DrawEnableLocks(BOOL Enable) { EnableLocks = Enable; }
