...
using EFFECT = struct _effect_def
{
...
extern void addEffect(iVector* pos, EFFECT_GROUP group, EFFECT_TYPE type, BOOL specified, struct iIMDShape* imd, BOOL lit);
extern void addMultiEffect(iVector* basePos, iVector* scatter, EFFECT_GROUP group, EFFECT_TYPE type, BOOL specified, struct iIMDShape* imd,
                           UDWORD number, BOOL lit, UDWORD size);
