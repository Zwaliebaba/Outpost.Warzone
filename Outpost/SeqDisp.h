...
extern BOOL seq_RenderVideoToBuffer(const iSurface* pSurface, const char* sequenceName, int time, int seqCommand);
...
//text
extern BOOL seq_AddTextForVideo(UBYTE* pText, SDWORD xOffset, SDWORD yOffset, SDWORD startTime, SDWORD endTime, SDWORD bJustify,
                                UDWORD PSXSeqNumber);
