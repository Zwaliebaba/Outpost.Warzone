...
// The droid orders
using DROID_ORDER = enum _droid_order
{
  DORDER_NONE,
  // no order set
...
using SECONDARY_ORDER = enum _secondary_order
{
  DSO_ATTACK_RANGE,
  DSO_REPAIR_LEVEL,
  DSO_ATTACK_LEVEL,
...
extern void orderDroidStatsLoc(DROID* psDroid, DROID_ORDER order, BASE_STATS* psStats, UDWORD x, UDWORD y);
...
/* Give a droid an order with a location and a stat */
extern void orderDroidStatsTwoLoc(DROID* psDroid, DROID_ORDER order, BASE_STATS* psStats, UDWORD x1, UDWORD y1, UDWORD x2, UDWORD y2);
...
extern void orderDroidStatsLocAdd(DROID* psDroid, DROID_ORDER order, BASE_STATS* psStats, UDWORD x, UDWORD y);
