...
ORDERBUTTONS OrderButtons[NUM_ORDERS] = {
  {
    ORDBUTCLASS_NORMAL, DSO_ATTACK_RANGE, DSS_ARANGE_MASK, ORD_BTYPE_RADIO, ORD_JUSTIFY_CENTER | ORD_JUSTIFY_NEWLINE, IDORDER_ATTACK_RANGE,
    3, 0, {IMAGE_ORD_RANGE3UP, IMAGE_ORD_RANGE1UP, IMAGE_ORD_RANGE2UP}, {IMAGE_ORD_RANGE3UP, IMAGE_ORD_RANGE1UP, IMAGE_ORD_RANGE2UP},
    {IMAGE_DES_HILIGHT, IMAGE_DES_HILIGHT, IMAGE_DES_HILIGHT}, {STR_DORD_RANGE3, STR_DORD_RANGE1, STR_DORD_RANGE2},
    {DSS_ARANGE_DEFAULT, DSS_ARANGE_SHORT, DSS_ARANGE_LONG}
  },
  {
    ORDBUTCLASS_NORMAL, DSO_REPAIR_LEVEL, DSS_REPLEV_MASK, ORD_BTYPE_RADIO, ORD_JUSTIFY_CENTER | ORD_JUSTIFY_NEWLINE, IDORDER_REPAIR_LEVEL,
    3, 0, {IMAGE_ORD_REPAIR3UP, IMAGE_ORD_REPAIR2UP, IMAGE_ORD_REPAIR1UP}, {IMAGE_ORD_REPAIR3UP, IMAGE_ORD_REPAIR2UP, IMAGE_ORD_REPAIR1UP},
    {IMAGE_DES_HILIGHT, IMAGE_DES_HILIGHT, IMAGE_DES_HILIGHT}, {STR_DORD_REPAIR3, STR_DORD_REPAIR2, STR_DORD_REPAIR1},
    {DSS_REPLEV_NEVER, DSS_REPLEV_HIGH, DSS_REPLEV_LOW}
  },
  {
    ORDBUTCLASS_NORMAL, DSO_ATTACK_LEVEL, DSS_ALEV_MASK, ORD_BTYPE_RADIO, ORD_JUSTIFY_CENTER | ORD_JUSTIFY_NEWLINE, IDORDER_ATTACK_LEVEL, 3,
    0, {IMAGE_ORD_FATWILLUP, IMAGE_ORD_RETFIREUP, IMAGE_ORD_HOLDFIREUP}, {IMAGE_ORD_FATWILLUP, IMAGE_ORD_RETFIREUP, IMAGE_ORD_HOLDFIREUP},
    {IMAGE_DES_HILIGHT, IMAGE_DES_HILIGHT, IMAGE_DES_HILIGHT}, {STR_DORD_FIRE1, STR_DORD_FIRE2, STR_DORD_FIRE3},
    {DSS_ALEV_ALWAYS, DSS_ALEV_ATTACKED, DSS_ALEV_NEVER}
  },
  {
    ORDBUTCLASS_NORMAL, DSO_FIRE_DESIGNATOR, DSS_FIREDES_MASK, ORD_BTYPE_BOOLEAN, ORD_JUSTIFY_COMBINE, IDORDER_FIRE_DESIGNATOR, 1, 0,
    {IMAGE_ORD_FIREDES_UP, 0, 0}, {IMAGE_ORD_FIREDES_UP, 0, 0}, {IMAGE_DES_HILIGHT, 0, 0}, {STR_DORD_FIREDES, 0, 0}, {DSS_FIREDES_SET, 0, 0}
  },
  {
    ORDBUTCLASS_NORMAL, DSO_PATROL, DSS_PATROL_MASK, ORD_BTYPE_BOOLEAN, ORD_JUSTIFY_COMBINE, IDORDER_PATROL, 1, 0,
    {IMAGE_ORD_PATROLUP, 0, 0}, {IMAGE_ORD_PATROLUP, 0, 0}, {IMAGE_DES_HILIGHT, 0, 0}, {STR_DORD_PATROL, 0, 0}, {DSS_PATROL_SET, 0, 0}
  },
  {
    ORDBUTCLASS_NORMAL, DSO_HALTTYPE, DSS_HALT_MASK, ORD_BTYPE_RADIO, ORD_JUSTIFY_CENTER | ORD_JUSTIFY_NEWLINE, IDORDER_HALT_TYPE, 3, 0,
    {IMAGE_ORD_PERSUEUP, IMAGE_ORD_GUARDUP, IMAGE_ORD_HALTUP}, {IMAGE_ORD_PERSUEUP, IMAGE_ORD_GUARDUP, IMAGE_ORD_HALTUP},
    {IMAGE_DES_HILIGHT, IMAGE_DES_HILIGHT, IMAGE_DES_HILIGHT}, {STR_DORD_PERSUE, STR_DORD_GUARD, STR_DORD_HOLDPOS},
    {DSS_HALT_PERSUE, DSS_HALT_GUARD, DSS_HALT_HOLD}
  },
  {
    ORDBUTCLASS_NORMAL, DSO_RETURN_TO_LOC, DSS_RTL_MASK, ORD_BTYPE_RADIO, ORD_JUSTIFY_CENTER | ORD_JUSTIFY_NEWLINE, IDORDER_RETURN, 3, 0,
    {IMAGE_ORD_RTRUP, IMAGE_ORD_GOTOHQUP, IMAGE_ORD_EMBARKUP}, {IMAGE_ORD_RTRUP, IMAGE_ORD_GOTOHQUP, IMAGE_ORD_EMBARKUP},
    {IMAGE_DES_HILIGHT, IMAGE_DES_HILIGHT, IMAGE_DES_HILIGHT}, {STR_DORD_RETREPAIR, STR_DORD_RETBASE, STR_DORD_EMBARK},
  ...
  //	},*/
  {
    ORDBUTCLASS_NORMAL, DSO_RECYCLE, DSS_RECYCLE_MASK, ORD_BTYPE_BOOLEAN_DEPEND, ORD_JUSTIFY_CENTER | ORD_JUSTIFY_NEWLINE, IDORDER_RECYCLE,
    2, 0, {IMAGE_ORD_DESTRUCT1UP, IMAGE_ORD_DESTRUCT2UP, 0}, {IMAGE_ORD_DESTRUCT1UP, IMAGE_ORD_DESTRUCT2GREY, 0},
    {IMAGE_DES_HILIGHT, IMAGE_DES_HILIGHT, 0}, {STR_DORD_ARMRECYCLE, STR_DORD_RECYCLE, 0}, {DSS_RECYCLE_SET, DSS_RECYCLE_SET, 0}
  },
  {
    ORDBUTCLASS_FACTORY, DSO_ASSIGN_PRODUCTION, DSS_ASSPROD_MASK, ORD_BTYPE_BOOLEAN_COMBINE, ORD_JUSTIFY_CENTER | ORD_JUSTIFY_NEWLINE,
    IDORDER_ASSIGN_PRODUCTION, 5, 0, {IMAGE_ORD_FAC1UP, IMAGE_ORD_FAC2UP, IMAGE_ORD_FAC3UP, IMAGE_ORD_FAC4UP, IMAGE_ORD_FAC5UP},
    ...
    {0x01 << DSS_ASSPROD_SHIFT, 0x02 << DSS_ASSPROD_SHIFT, 0x04 << DSS_ASSPROD_SHIFT, 0x08 << DSS_ASSPROD_SHIFT, 0x10 << DSS_ASSPROD_SHIFT}
  },
  {
    ORDBUTCLASS_CYBORGFACTORY, DSO_ASSIGN_CYBORG_PRODUCTION, DSS_ASSPROD_MASK, ORD_BTYPE_BOOLEAN_COMBINE,
    ORD_JUSTIFY_CENTER | ORD_JUSTIFY_NEWLINE, IDORDER_ASSIGN_CYBORG_PRODUCTION, 5, 0,
    {IMAGE_ORD_FAC1UP, IMAGE_ORD_FAC2UP, IMAGE_ORD_FAC3UP, IMAGE_ORD_FAC4UP, IMAGE_ORD_FAC5UP},
    {IMAGE_ORD_FAC1UP, IMAGE_ORD_FAC2UP, IMAGE_ORD_FAC3UP, IMAGE_ORD_FAC4UP, IMAGE_ORD_FAC5UP},
    {IMAGE_ORD_FACHILITE, IMAGE_ORD_FACHILITE, IMAGE_ORD_FACHILITE, IMAGE_ORD_FACHILITE, IMAGE_ORD_FACHILITE},
  ...
  {
    ORDBUTCLASS_VTOLFACTORY, DSO_ASSIGN_VTOL_PRODUCTION, DSS_ASSPROD_MASK, ORD_BTYPE_BOOLEAN_COMBINE,
    ORD_JUSTIFY_CENTER | ORD_JUSTIFY_NEWLINE, IDORDER_ASSIGN_VTOL_PRODUCTION, 5, 0,
    {IMAGE_ORD_FAC1UP, IMAGE_ORD_FAC2UP, IMAGE_ORD_FAC3UP, IMAGE_ORD_FAC4UP, IMAGE_ORD_FAC5UP},
    {IMAGE_ORD_FAC1UP, IMAGE_ORD_FAC2UP, IMAGE_ORD_FAC3UP, IMAGE_ORD_FAC4UP, IMAGE_ORD_FAC5UP},
    {IMAGE_ORD_FACHILITE, IMAGE_ORD_FACHILITE, IMAGE_ORD_FACHILITE, IMAGE_ORD_FACHILITE, IMAGE_ORD_FACHILITE},
    {STR_DORD_VTOL_FACTORY, STR_DORD_VTOL_FACTORY, STR_DORD_VTOL_FACTORY, STR_DORD_VTOL_FACTORY, STR_DORD_VTOL_FACTORY},
    {
      0x01 << DSS_ASSPROD_VTOL_SHIFT, 0x02 << DSS_ASSPROD_VTOL_SHIFT, 0x04 << DSS_ASSPROD_VTOL_SHIFT, 0x08 << DSS_ASSPROD_VTOL_SHIFT,
      0x10 << DSS_ASSPROD_VTOL_SHIFT
    }
  },
};
...
{
  if (widgGetFromID(psWScreen,IDORDER_FORM) != nullptr && OrderUp)
  {
...
BOOL _intAddOrder(BASE_OBJECT* psObj)
{
  ...
  if (psObj)
  {
    ...
    {
      DEBUG_ASSERT_TEXT(FALSE, "_intAddOrder: Invalid object type");
      Droid = nullptr;
      psStructure = nullptr;
    }
  }
  ...
  for (j = 0; ((j < NumAvailableOrders) && (NumDisplayedOrders < MAX_DISPLAYABLE_ORDERS)); j++)
  {
    ...
    case ORDBUTCLASS_FACTORY:
      NumButs = countAssignableFactories(static_cast<UBYTE>(selectedPlayer),FACTORY_FLAG);
      break;
    case ORDBUTCLASS_CYBORGFACTORY:
      NumButs = countAssignableFactories(static_cast<UBYTE>(selectedPlayer),CYBORG_FLAG);
      break;
    case ORDBUTCLASS_VTOLFACTORY:
      NumButs = countAssignableFactories(static_cast<UBYTE>(selectedPlayer),VTOL_FLAG);
      break;
    }
    ...
    case ORD_JUSTIFY_COMBINE:
      ...
      for (i = 0; i < j; i++)
      {
        if ((OrderButtons[AvailableOrders[i].OrderIndex].ButJustify & ORD_JUSTIFY_MASK) == ORD_JUSTIFY_COMBINE)
          NumCombineBefore += 1;
      }
      NumCombineButs = static_cast<UWORD>(NumCombineBefore + 1);

      // now see how many in total
      for (i = static_cast<UWORD>(j + 1); i < NumAvailableOrders; i++)
      {
        if ((OrderButtons[AvailableOrders[i].OrderIndex].ButJustify & ORD_JUSTIFY_MASK) == ORD_JUSTIFY_COMBINE)
          NumCombineButs += 1;
      }
      ...
      NumCombineButs = static_cast<UWORD>(NumCombineButs - (NumCombineBefore - (NumCombineBefore % ORD_MAX_COMBINE_BUTS)));
    ...
    for (i = 0; i < OrderButtons[OrdIndex].AcNumButs; i++)
    {
      ...
      case ORD_BTYPE_BOOLEAN:
        if ((State & OrderButtons[OrdIndex].StateMask) == static_cast<UDWORD>(OrderButtons[OrdIndex].States[i]))
      ...
      case ORD_BTYPE_BOOLEAN_COMBINE:
        if (State & static_cast<UDWORD>(OrderButtons[OrdIndex].States[i]))
          widgSetButtonState(psWScreen, sButInit.id, WBUT_CLICKLOCK);
        break;
      }
      ...
      if (!bHidden)
        sButInit.x = static_cast<SWORD>(sButInit.x + sButInit.width + ORDER_BUTGAP);
      sButInit.id++;
    }

    if (((OrderButtons[OrdIndex].ButJustify & ORD_JUSTIFY_MASK) != ORD_JUSTIFY_COMBINE) || bLastCombine)
    {
      sButInit.y = static_cast<SWORD>(sButInit.y + sButInit.height + ORDER_BUTGAP);
      Height = static_cast<UWORD>(Height + sButInit.height + ORDER_BUTGAP);
    }
    NumDisplayedOrders++;
  }
  ...
  Form->height = static_cast<UWORD>(Height + CLOSE_HEIGHT + ORDER_BUTGAP);
  Form->y = static_cast<SWORD>((ORDER_BOTTOMY - Form->height));
  ...
  for (OrdIndex = 0; OrdIndex < NUM_ORDERS; OrdIndex++)
  {
    ...
    case ORD_BTYPE_RADIO:
      if ((id >= BaseID) && (id < BaseID + OrderButtons[OrdIndex].AcNumButs))
      {
        ...
        if (SetSecondaryState(OrderButtons[OrdIndex].Order, OrderButtons[OrdIndex].States[StateIndex] & OrderButtons[OrdIndex].StateMask))
    ...
    case ORD_BTYPE_BOOLEAN:
      if ((id >= BaseID) && (id < BaseID + OrderButtons[OrdIndex].AcNumButs))
      {
        ...
        {
          widgSetButtonState(psWScreen, id, WBUT_CLICKLOCK);
          SetSecondaryState(OrderButtons[OrdIndex].Order, OrderButtons[OrdIndex].States[StateIndex] & OrderButtons[OrdIndex].StateMask);
        }
      }
      break;
    ...
    case ORD_BTYPE_BOOLEAN_COMBINE:
      if ((id >= BaseID) && (id < BaseID + OrderButtons[OrdIndex].AcNumButs))
      {
        ...
        // set the final state
        SetSecondaryState(OrderButtons[OrdIndex].Order, CombineState & OrderButtons[OrdIndex].StateMask);
      }
      break;
    }
  }
...
//
BOOL intRefreshOrder(void) { return _intRefreshOrder(); }
...
void intProcessOrder(UDWORD id) { _intProcessOrder(id); }
...
static BOOL BuildStructureOrderList(STRUCTURE* psStructure)
{
  ...
  {
    DEBUG_ASSERT_TEXT(FALSE, "BuildStructureOrderList: structure is not a factory");
    return FALSE;
  }
...
static BOOL CheckObjectOrderList(void)
{
  ...
  if (psSelectedFactory != nullptr)
  {
    ...
    {
      DEBUG_ASSERT_TEXT(FALSE, "CheckObjectOrderList: structure is not a factory");
      return FALSE;
    }
