...
using DROID_TYPE = enum _droid_type
{
  DROID_WEAPON,
  // Weapon droid
  DROID_SENSOR,
...
using COMPONENT = struct _component
{
...
using ORDER_LIST = struct _order_list
{
  SDWORD order;
...
using DROID_TEMPLATE = struct _droid_template
{
  // FOR DROID TEMPLATES
