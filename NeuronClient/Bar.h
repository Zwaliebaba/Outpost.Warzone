...
extern void barGraphDisplay(WIDGET* psWidget, UDWORD xOffset, UDWORD yOffset, UDWORD* pColours);

/* The double bar graph display function */
extern void barGraphDisplayDouble(WIDGET* psWidget, UDWORD xOffset, UDWORD yOffset, UDWORD* pColours);

/* The trough bar graph display function */
extern void barGraphDisplayTrough(WIDGET* psWidget, UDWORD xOffset, UDWORD yOffset, UDWORD* pColours);
